    ...
    private void renderFrame()
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            textureIndex=1;
             ...
             else  if(trackable.getName().equalsIgnoreCase("bertel"))
            textureIndex =4;
             else if(trackable.getName().equalsIgnoreCase("echtler"))
            textureIndex = 5;
            else if(trackable.getName().equalsIgnoreCase("rodehorst2")||trackable.getName().equalsIgnoreCase("rodehorst"))
            textureIndex = 6;
            else if(trackable.getName().equalsIgnoreCase("stein"))
            textureIndex = 7;
            else if(trackable.getName().equalsIgnoreCase("hornecker"))
            textureIndex = 8;
            else if(trackable.getName().equalsIgnoreCase("schatter"))
                textureIndex = 9;
            else if(trackable.getName().equalsIgnoreCase("wuethrich"))
                textureIndex = 10;
            else if(trackable.getName().equalsIgnoreCase("jakoby"))
                textureIndex = 11;
            else
            textureIndex = 0;
...
/*            if (!mActivity.isExtendedTrackingActive())
            ...
            if (!mActivity.isExtendedTrackingActive())
            {
                ...
                if(trackable.getName().equalsIgnoreCase("city")||trackable.getName().equalsIgnoreCase("cat")
                ...
                GLES20.glDisableVertexAttribArray(textureCoordHandle);
                    ...
                    Log.e("Kuchen","bin in else");
                    Matrix.translateM(modelViewMatrix, 0, 0.0f, 0.0f,
                            OBJECT_SCALE_FLOAT);

                    Matrix.scaleM(modelViewMatrix, 0, 29.143f,
                            40.0f, 10.0f);
